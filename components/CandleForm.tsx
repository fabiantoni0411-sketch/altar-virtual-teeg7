  ...
  return (
    <form onSubmit={handleSubmit} className="max-w-md mx-auto space-y-5">
      <div className="grid gap-4">
        ...
        {corSelecionada && (
          <div className="rounded-xl bg-altar-navy/50 border border-altar-gold/20 p-4 text-sm text-altar-mist space-y-2">
            {corSelecionada.imagens && corSelecionada.imagens.length > 0 && (
              <div className="flex gap-2 justify-center flex-wrap pb-2">
                {corSelecionada.imagens.map((img, i) => (
                  <img
                    key={i}
                    src={img}

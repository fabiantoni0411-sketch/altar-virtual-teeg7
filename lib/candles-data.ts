...
export const CANDLES: CandleDefinition[] = [
  ...
  { id: "rosa-azul-clara", label: "Rosa e Azul Clara", tipo: "bicolor", orixa: "Cosme e Damião", hexPrimary: "#F2A9C4", hexSecondary: "#A9C6F5", significados: ["proteção infantil", "alegria", "inocência", "bênçãos para as crianças"], indicacao: "Pedidos de proteção para crianças e bênçãos da dupla de santos Cosme e Damião." },
  { id: "vermelha-azul-marinho", label: "Vermelha e Azul Marinho", tipo: "bicolor", orixa: "Ogum", hexPrimary: "#B91C1C", hexSecondary: "#0B1447", significados: ["força", "coragem", "vitória em batalhas", "proteção guerreira"], indicacao: "Superar obstáculos com força e coragem, sob a proteção de Ogum." },
];
